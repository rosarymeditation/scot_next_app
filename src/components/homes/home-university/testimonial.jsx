...
import { POST_TESTIMONIES } from "../../../utils/global";
...
const contents = {
  ...
  desc: "Honest Testimonials and Powerful Insights on Education's Influence, Challenges, and Path to Success, Straight from the Hearts of Our Exceptional Students.",
  testimonial_items: [
    {
      ...
      <div className="container edublink-animated-shape">
        ...
        >
          {testimonies.map((item, i) => {
            const { desc, url, firstname, content, ratings, title } = item;
            return (
              <SwiperSlide key={i}>
